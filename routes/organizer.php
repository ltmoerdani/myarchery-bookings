...
Route::prefix('/organizer')->middleware('auth:organizer', 'Deactive:organizer', 'EmailStatus:organizer', 'adminLang')->group(function () {
  ...
  Route::post('event-store-tournament', 'BackEnd\Organizer\EventController@store_tournament')->name('organizer.event_management.store_event_tournament');
  ...
  Route::post('/delete-event-tournament/{id}', 'BackEnd\Organizer\EventController@destroy_tournament')->name('organizer.event_management.delete_event_tournament');
