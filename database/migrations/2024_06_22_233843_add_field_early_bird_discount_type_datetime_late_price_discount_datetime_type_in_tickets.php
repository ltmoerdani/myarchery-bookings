...
return new class extends Migration
{
  ...
  public function up()
  {
    Schema::table('tickets', function (Blueprint $table) {
      ...
      $table->string('late_price_discount_end_time')->nullable()->after('late_price_discount_end_date')->comment('use for local end time late price tournament and support for outer tournament event')->change();
