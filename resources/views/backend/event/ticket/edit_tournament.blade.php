                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-10 mx-auto">
                            ...
                            <form id="eventForm" action="{{ route('admin.ticket_management.update_ticket') }}"
                                        ...
                                        <div class="col-lg-6 {{ $ticket->pricing_type == 'normal' ? '' : 'd-none' }}"
                                            ...
                                            <div class="form-group">
                                                <label for="">{{ __('International Price') }}
                                                    ({{ $getCurrencyInfo->base_currency_text }}) *</label>
                                                <input type="number" name="international_price"
                                                    value="{{ $ticket->international_price }}" class="form-control"
