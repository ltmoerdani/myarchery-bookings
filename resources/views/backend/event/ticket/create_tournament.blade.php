                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-10 mx-auto">
                            ...
                            <form id="eventForm" action="{{ route('admin.ticket_management.store_ticket') }}"
                                ...
                                @if (request()->input('event_type') == 'venue' || request()->input('event_type') == 'tournament')
                                    <div class="row ">
                                                                ...
                                                                <td>
                                                                    <div class="from-group mt-1">
                                                                        <input type="checkbox" checked
                                                                            ...
                                                                            value="limited" class="ticket_available_type"
                                        ...
                                        <div class="col-lg-6 d-none" id="normal_pricing">
                                            ...
                                            <div class="form-group">
                                                <label for="">{{ __('International Price') }}
                                                    ({{ $getCurrencyInfo->base_currency_text }})
                                                    *</label>
                                                <input type="number" name="international_price" class="form-control"
                                                    placeholder="Enter Price">
                                            </div>
                                        </div>
