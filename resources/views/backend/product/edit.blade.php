                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            ...
                            <form id="eventForm" action="{{ route('admin.shop_management.product.update') }}"
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="previous_price"
                                                value="{{ $product->previous_price }}" placeholder="Enter Previous Price"
                                                class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="is_feature" class="form-control">
                                                ...
                                                <option {{ $product->is_feature == 'yes' ? 'selected' : '' }}
                                                    value="yes">
                                                    {{ __('Yes') }}
                                                </option>
                                                <option {{ $product->is_feature == 'no' ? 'selected' : '' }}
                                                    value="no">{{ __('No') }}
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        @if ($product->type == 'digital')
                                            <div class="form-group">
                                                ...
                                                <select name="file_type" class="form-control" id="fileType">
                                                    <option {{ $product->file_type == 'upload' ? 'selected' : '' }}
                                                        value="upload" selected>
                                                        {{ __('File Upload') }}</option>
                                                    <option {{ $product->file_type == 'link' ? 'selected' : '' }}
                                                        value="link">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div id="downloadLink"
                                                ...
                                                <input name="download_link" type="text"
                                                    value="{{ $product->download_link }}" class="form-control">
                                                            ...
                                                            <div
                                                                ...
                                                                <select name="{{ $language->code }}_category_id"
                                                                    ...
                                                                    @foreach ($categories as $category)
                                                                        <option @selected(@$product_content->category_id == $category->id)
                                                                            value="{{ $category->id }}">
