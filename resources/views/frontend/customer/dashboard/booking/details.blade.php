                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <a href="{{ route('customer.booking.my_booking') }}"
                                                    class="btn float-lg-right float-left">
                                                    {{ __('back') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="payment-information">
                                                    ...
                                                    @endif
                                                    @if (!is_null($booking->handling_fee_amount))
                                                        <p><b>{{ __('Handling Fee') . ' : ' }} </b>
                                                            <span dir="ltr">
                                                                {{ $position == 'left' ? $currency . ' ' : '' }}{{ $booking->handling_fee_amount }}{{ $position == 'right' ? ' ' . $currency : '' }}
                                                            </span>
                                                        </p>
                                                    @endif
                                                    ...
                                                    <p><b>{{ __('Payment Status') . ' : ' }} </b> <span
                                                            class="badge {{ $booking->paymentStatus == 'completed' || $booking->paymentStatus == 'free' ? 'badge-success' : 'badge-danger' }} ">{{ __($booking->paymentStatus) }}</span>
                                                    </p>
