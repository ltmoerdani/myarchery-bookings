        ...
        <form method="post" action="{{ route('LaravelInstaller::licenseCheck') }}" class="tabs-wrap">
            ...
            <div>
                <div class="form-group {{ $errors->has('email') ? ' has-error ' : '' }}">
                    ...
                    <p>This Mail Address will be used to inform you about Urgent Notices, Announcements, Offers / Sales
                        etc...</p>
                    @if ($errors->has('email'))
                ...
                <div class="form-group {{ $errors->has('username') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="username" id="username" value=""
                        placeholder="Username of Your Envato Account" />
                ...
                <div class="form-group {{ $errors->has('purchase_code') ? ' has-error ' : '' }}">
                    <label for="purchase_code">
                        Purchase Code Nulled Code By Myarchery
                    </label>
                    <input type="text" name="purchase_code" id="purchase_code" value=""
                        placeholder="Your Item Purchase Code" />
